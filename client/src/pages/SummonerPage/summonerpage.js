...
export default function Summonerpage() {
  ...
  useEffect(() => {
    if (state !== null)
      setInitInfo({ region: state.region, name: state.summonerName });
  }, []);
  ...
  function handleInputSubmit(e) {
    ...
    let currentSummonerName = document.querySelector(
      ".summonerpage__search-input"
    );
      ...
      <div className="summonerpage isLoading">
        <form className="summonerpage__region-and-name-search">
          ...
          <div className="summonerpage__search-input-wrapper">
            ...
            <input
              className="input summonerpage__search-input"
              type="text"
            />
          </div>
          <button
  ...
  return (
    <div className="summonerpage">
      ...
      <RankedSolo
        ...
        region={currentInitInfo.region}
      />
      <GameList
        currentInitInfo={currentInitInfo}
        puuid={account.puuid}
      />
    </div>
  );
